...
int main(int argc, char **argv) {
    ...
    int tag_descriptor_2;
    tag_descriptor_2 = tag_get(2, IPC_CREAT, getuid());
    ...
    args_receivers_2->tag = tag_descriptor_2;
    args_receivers_2->level = 1;
    args_receivers_2->msg_size = 100;


    pthread_t tid_rcv_1, tid_rcv_2, tid_rcv_3, tid_rcv_4, tid_snd_1, tid_snd_2;
